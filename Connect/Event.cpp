        ...
        case SDL_MOUSEBUTTONDOWN: {
            switch(Event->button.button) {
				...
				case SDL_BUTTON_WHEELUP: {
					OnMouseWheel(true, false, Event->button.x, Event->button.y);
					break;
				}
				case SDL_BUTTON_WHEELDOWN: {
					OnMouseWheel(false, true, Event->button.x, Event->button.y);
					break;
				}
            }
            break;
...
void Event::OnMouseWheel(bool Up, bool Down, int mX, int mY) {
    //Pure virtual, do nothing
}
